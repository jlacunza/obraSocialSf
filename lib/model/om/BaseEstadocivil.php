...
/**
 * Base class that represents a row from the 'estadocivil' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseEstadocivil extends BaseObject 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EstadocivilPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EstadocivilQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EstadocivilPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(EstadocivilPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }

        $sql = sprintf(
            'INSERT INTO `estadocivil` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Estadocivil'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Estadocivil'][$this->getPrimaryKey()] = true;
     ...
     * If this Estadocivil is new, it will return
    ...
    public function setAfiliados(PropelCollection $afiliados, PropelPDO $con = null)
    {
        ...
        foreach ($this->afiliadosScheduledForDeletion as $afiliadoRemoved) {
            $afiliadoRemoved->setEstadocivil(null);
        }
    ...
    {
        return (string) $this->exportTo(EstadocivilPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseEstadocivil:' . $name))
		{
