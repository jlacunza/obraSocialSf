...
abstract class BaseUsuarioPeer {
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'User', 'Password', 'RolId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'user', 'password', 'rolId', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::USER, self::PASSWORD, self::ROL_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER', 'PASSWORD', 'ROL_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user', 'password', 'rol_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'User' => 1, 'Password' => 2, 'RolId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'user' => 1, 'password' => 2, 'rolId' => 3, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER => 1, self::PASSWORD => 2, self::ROL_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER' => 1, 'PASSWORD' => 2, 'ROL_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user' => 1, 'password' => 2, 'rol_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioPeer::USER);
            $criteria->addSelectColumn(UsuarioPeer::PASSWORD);
            $criteria->addSelectColumn(UsuarioPeer::ROL_ID);
        } else {
    ...
    public static function doCountJoinRol(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UsuarioPeer::ROL_ID, RolPeer::ID, $join_behavior);
