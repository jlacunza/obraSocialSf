 ...
 *
 * @method     EspecialidadQuery leftJoinPrestador($relationAlias = null) Adds a LEFT JOIN clause to the query using the Prestador relation
 * @method     EspecialidadQuery rightJoinPrestador($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Prestador relation
 * @method     EspecialidadQuery innerJoinPrestador($relationAlias = null) Adds a INNER JOIN clause to the query using the Prestador relation
 *
...
abstract class BaseEspecialidadQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `DESCRIPCION` FROM `especialidad` WHERE `ID` = :p0';
        try {
    ...
    public function filterByPrestador($prestador, $comparison = null)
    {
        if ($prestador instanceof Prestador) {
            return $this
                ->addUsingAlias(EspecialidadPeer::ID, $prestador->getEspecialidadId(), $comparison);
