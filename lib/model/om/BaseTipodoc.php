...
/**
 * Base class that represents a row from the 'tipodoc' table.
 *
 * 
 *
...
abstract class BaseTipodoc extends BaseObject 
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TipodocPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = TipodocPeer::DESCRIPCION;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = TipodocPeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TipodocPeer::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TipodocPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(TipodocPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }

        $sql = sprintf(
            'INSERT INTO `tipodoc` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipodocPeer::ID)) $criteria->add(TipodocPeer::ID, $this->id);
        if ($this->isColumnModified(TipodocPeer::DESCRIPCION)) $criteria->add(TipodocPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(TipodocPeer::DATABASE_NAME);
        $criteria->add(TipodocPeer::ID, $this->id);
    ...
    public function setAfiliados(PropelCollection $afiliados, PropelPDO $con = null)
    {
        ...
        foreach ($this->afiliadosScheduledForDeletion as $afiliadoRemoved) {
            $afiliadoRemoved->setTipodoc(null);
        }
