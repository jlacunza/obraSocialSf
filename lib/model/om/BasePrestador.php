 ...
 */
abstract class BasePrestador extends BaseObject 
{
    ...
    /**
     * The value for the apenom field.
     * @var        string
     */
    protected $apenom;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PrestadorPeer::ID;
        }
    ...
    /**
     * Set the value of [apenom] column.
     * 
    ...
    public function setApenom($v)
    {
        ...
        if ($this->apenom !== $v) {
            $this->apenom = $v;
            $this->modifiedColumns[] = PrestadorPeer::APENOM;
        }
    ...
    public function setCalle($v)
    {
        ...
        if ($this->calle !== $v) {
            $this->calle = $v;
            $this->modifiedColumns[] = PrestadorPeer::CALLE;
        }
    ...
    public function setNumero($v)
    {
        ...
        if ($this->numero !== $v) {
            $this->numero = $v;
            $this->modifiedColumns[] = PrestadorPeer::NUMERO;
        }
    ...
    public function setPiso($v)
    {
        ...
        if ($this->piso !== $v) {
            $this->piso = $v;
            $this->modifiedColumns[] = PrestadorPeer::PISO;
        }
    ...
    public function setDepto($v)
    {
        ...
        if ($this->depto !== $v) {
            $this->depto = $v;
            $this->modifiedColumns[] = PrestadorPeer::DEPTO;
        }
    ...
    public function setLocalidadId($v)
    {
        ...
        if ($this->localidad_id !== $v) {
            $this->localidad_id = $v;
            $this->modifiedColumns[] = PrestadorPeer::LOCALIDAD_ID;
        }
    ...
    public function setEspecialidadId($v)
    {
        ...
        if ($this->especialidad_id !== $v) {
            ...
            $this->modifiedColumns[] = PrestadorPeer::ESPECIALIDAD_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->apenom = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->calle = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->numero = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->piso = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->depto = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->localidad_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->especialidad_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = PrestadorPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aEspecialidad !== null && $this->especialidad_id !== $this->aEspecialidad->getId()) {
            $this->aEspecialidad = null;
        }
    } // ensureConsistency
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PrestadorQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PrestadorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(PrestadorPeer::APENOM)) {
            $modifiedColumns[':p' . $index++]  = '`APENOM`';
        }
        if ($this->isColumnModified(PrestadorPeer::CALLE)) {
            $modifiedColumns[':p' . $index++]  = '`CALLE`';
        }
        if ($this->isColumnModified(PrestadorPeer::NUMERO)) {
            $modifiedColumns[':p' . $index++]  = '`NUMERO`';
        }
        if ($this->isColumnModified(PrestadorPeer::PISO)) {
            $modifiedColumns[':p' . $index++]  = '`PISO`';
        }
        if ($this->isColumnModified(PrestadorPeer::DEPTO)) {
            $modifiedColumns[':p' . $index++]  = '`DEPTO`';
        }
        if ($this->isColumnModified(PrestadorPeer::LOCALIDAD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`LOCALIDAD_ID`';
        }
        if ($this->isColumnModified(PrestadorPeer::ESPECIALIDAD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ESPECIALIDAD_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `prestador` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID`':
                        ...
                        break;
                    case '`APENOM`':
						$stmt->bindValue($identifier, $this->apenom, PDO::PARAM_STR);
                        break;
                    case '`CALLE`':
                    ...
                    case '`ESPECIALIDAD_ID`':
						$stmt->bindValue($identifier, $this->especialidad_id, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        if (isset($alreadyDumpedObjects['Prestador'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Prestador'][$this->getPrimaryKey()] = true;
        $keys = PrestadorPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getApenom(),
            $keys[2] => $this->getCalle(),
            $keys[3] => $this->getNumero(),
            $keys[4] => $this->getPiso(),
            $keys[5] => $this->getDepto(),
            $keys[6] => $this->getLocalidadId(),
            $keys[7] => $this->getEspecialidadId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setApenom($arr[$keys[1]]);
        ...
        if (array_key_exists($keys[7], $arr)) $this->setEspecialidadId($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrestadorPeer::ID)) $criteria->add(PrestadorPeer::ID, $this->id);
        if ($this->isColumnModified(PrestadorPeer::APENOM)) $criteria->add(PrestadorPeer::APENOM, $this->apenom);
        if ($this->isColumnModified(PrestadorPeer::CALLE)) $criteria->add(PrestadorPeer::CALLE, $this->calle);
        if ($this->isColumnModified(PrestadorPeer::NUMERO)) $criteria->add(PrestadorPeer::NUMERO, $this->numero);
        if ($this->isColumnModified(PrestadorPeer::PISO)) $criteria->add(PrestadorPeer::PISO, $this->piso);
        if ($this->isColumnModified(PrestadorPeer::DEPTO)) $criteria->add(PrestadorPeer::DEPTO, $this->depto);
        if ($this->isColumnModified(PrestadorPeer::LOCALIDAD_ID)) $criteria->add(PrestadorPeer::LOCALIDAD_ID, $this->localidad_id);
        if ($this->isColumnModified(PrestadorPeer::ESPECIALIDAD_ID)) $criteria->add(PrestadorPeer::ESPECIALIDAD_ID, $this->especialidad_id);
    ...
    {
        $criteria = new Criteria(PrestadorPeer::DATABASE_NAME);
        $criteria->add(PrestadorPeer::ID, $this->id);
    ...
    public function getLocalidad(PropelPDO $con = null)
    {
        if ($this->aLocalidad === null && ($this->localidad_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLocalidad->addPrestadors($this);
             */
        }
    ...
    public function setEspecialidad(Especialidad $v = null)
    {
        if ($v === null) {
            ...
            $this->setEspecialidadId($v->getId());
        }
    ...
    {
        if ($this->aEspecialidad === null && ($this->especialidad_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEspecialidad->addPrestadors($this);
             */
        }
     ...
     * If this Prestador is new, it will return
    ...
    public function setCentroatencionHasPrestadors(PropelCollection $centroatencionHasPrestadors, PropelPDO $con = null)
    {
        ...
        foreach ($this->centroatencionHasPrestadorsScheduledForDeletion as $centroatencionHasPrestadorRemoved) {
            $centroatencionHasPrestadorRemoved->setPrestador(null);
        }
    ...
    protected function doAddCentroatencionHasPrestador($centroatencionHasPrestador)
    {
        ...
        $centroatencionHasPrestador->setPrestador($this);
    }
    ...
    public function removeCentroatencionHasPrestador($centroatencionHasPrestador)
    {
        if ($this->getCentroatencionHasPrestadors()->contains($centroatencionHasPrestador)) {
            ...
            $centroatencionHasPrestador->setPrestador(null);
        }
    }
     ...
     * @return PropelObjectCollection|CentroatencionHasPrestador[] List of CentroatencionHasPrestador objects
     */
    public function getCentroatencionHasPrestadorsJoinCentroatencion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CentroatencionHasPrestadorQuery::create(null, $criteria);
        $query->joinWith('Centroatencion', $join_behavior);
    ...
    {
        return (string) $this->exportTo(PrestadorPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BasePrestador:' . $name))
		{
