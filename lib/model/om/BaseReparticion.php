...
/**
 * Base class that represents a row from the 'reparticion' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseReparticion extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'ReparticionPeer';
     ...
     * @return   Reparticion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ReparticionPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = ReparticionPeer::DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ReparticionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Reparticion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ReparticionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(ReparticionPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = ReparticionQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseReparticion:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseReparticion:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseReparticion:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseReparticion:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                ReparticionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ReparticionPeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ReparticionPeer::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ReparticionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(ReparticionPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }

        $sql = sprintf(
            'INSERT INTO `reparticion` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ReparticionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ReparticionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Reparticion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Reparticion'][$this->getPrimaryKey()] = true;
        $keys = ReparticionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(ReparticionPeer::DATABASE_NAME);

        if ($this->isColumnModified(ReparticionPeer::ID)) $criteria->add(ReparticionPeer::ID, $this->id);
        if ($this->isColumnModified(ReparticionPeer::DESCRIPCION)) $criteria->add(ReparticionPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(ReparticionPeer::DATABASE_NAME);
        $criteria->add(ReparticionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of Reparticion (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Reparticion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   ReparticionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ReparticionPeer();
        }
     ...
     * If this Reparticion is new, it will return
    ...
    public function setAfiliados(PropelCollection $afiliados, PropelPDO $con = null)
    {
        ...
        foreach ($this->afiliadosScheduledForDeletion as $afiliadoRemoved) {
            $afiliadoRemoved->setReparticion(null);
        }
     ...
     * Otherwise if this Reparticion is new, it will return
     * an empty collection; or if this Reparticion has previously
     * been saved, it will retrieve related Afiliados from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Reparticion.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Afiliado[] List of Afiliado objects
     */
    public function getAfiliadosJoinLocalidad($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = AfiliadoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ReparticionPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseReparticion:' . $name))
		{
