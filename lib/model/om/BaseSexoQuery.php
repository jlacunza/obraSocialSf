 ...
 * @method     SexoQuery orderByDescripcion($order = Criteria::ASC) Order by the descripcion column
 *
 * @method     SexoQuery groupById() Group by the id column
 * @method     SexoQuery groupByDescripcion() Group by the descripcion column
 *
 ...
 *
 * @method     SexoQuery leftJoinAfiliado($relationAlias = null) Adds a LEFT JOIN clause to the query using the Afiliado relation
 * @method     SexoQuery rightJoinAfiliado($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Afiliado relation
 * @method     SexoQuery innerJoinAfiliado($relationAlias = null) Adds a INNER JOIN clause to the query using the Afiliado relation
 *
 ...
 *
 * @method     Sexo findOneById(int $id) Return the first Sexo filtered by the id column
 * @method     Sexo findOneByDescripcion(string $descripcion) Return the first Sexo filtered by the descripcion column
 *
 * @method     array findById(int $id) Return Sexo objects filtered by the id column
 * @method     array findByDescripcion(string $descripcion) Return Sexo objects filtered by the descripcion column
 *
...
abstract class BaseSexoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `DESCRIPCION` FROM `sexo` WHERE `ID` = :p0';
        try {
    ...
    public function filterByDescripcion($descripcion = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SexoPeer::DESCRIPCION, $descripcion, $comparison);
    }
    ...
    public function filterByAfiliado($afiliado, $comparison = null)
    {
        if ($afiliado instanceof Afiliado) {
            return $this
                ->addUsingAlias(SexoPeer::ID, $afiliado->getSexoId(), $comparison);
