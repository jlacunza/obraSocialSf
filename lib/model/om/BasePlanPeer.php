...
/**
 * Base static class for performing query and update operations on the 'plan' table.
 *
 * 
 *
...
abstract class BasePlanPeer {
    ...
    const DESCUENTO = 'plan.DESCUENTO';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Plan objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'Descuento', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'descuento', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::DESCRIPCION, self::DESCUENTO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'DESCUENTO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'descuento', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'Descuento' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'descuento' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DESCRIPCION => 1, self::DESCUENTO => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'DESCUENTO' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'descuento' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlanPeer::DESCUENTO);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
		...
		{
		  call_user_func($sf_hook, 'BasePlanPeer', $criteria, $con);
		}
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePlanPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PlanTableMap());
      }
    }
	...
	{
	  return array(array('descripcion'), array('descuento'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePlanPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
