...
/**
 * This class defines the structure of the 'tipodoc' table.
 *
 *
 *
...
class TipodocTableMap extends TableMap
{
    ...
    {
        $this->addRelation('Afiliado', 'Afiliado', RelationMap::ONE_TO_MANY, array('id' => 'tipodoc_id', ), null, null, 'Afiliados');
    } // buildRelations()
